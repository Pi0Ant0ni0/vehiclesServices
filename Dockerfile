...
WORKDIR ${JBOSS_HOME}/modules/system/layers/base/com/mongodb/main
ADD module.xml .
RUN curl -O https://repo1.maven.org/maven2/org/mongodb/mongo-java-driver/3.12.11/mongo-java-driver-3.12.11.jar
